...
|                                                                                                                                                                                                                                                                                                                                                                    |         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- |
| [New Block Support in WordPress 7.1: Background Gradient (background.gradient)](https://make.wordpress.org/core/2026/07/26/new-block-support-in-wordpress-7-1-background-gradient-background-gradient/?ref=dailydev)                                                                                                                                               | 7/26/26 |
| [Text Shadow Support in Global Styles](https://make.wordpress.org/core/2026/07/23/text-shadow-support-in-global-styles/?ref=dailydev)                                                                                                                                                                                                                              | 7/23/26 |
| [WordForge - An opinionated MVC structure from Wordpress Plugins development](https://app.daily.dev/posts/wordforge---an-opinionated-mvc-structure-from-wordpress-plugins-development-etftdgtqt)                                                                                                                                                                   | 4/29/25 |
